...
FIXEDRANDOMSEED1_ANY_OF_SCHEMAS = ["object"]

class FixedRandomSeed1(BaseModel):
    """
    ...
    any_of_schemas: List[str] = Literal[FIXEDRANDOMSEED1_ANY_OF_SCHEMAS]
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = FixedRandomSeed1.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in FixedRandomSeed1 with anyOf schemas: object. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FixedRandomSeed1 with anyOf schemas: object. Details: " + ", ".join(error_messages))
        else:
            return instance
