...
IGNOREEOS_ANY_OF_SCHEMAS = ["bool", "object"]

class IgnoreEos(BaseModel):
    """
    IgnoreEos
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = IgnoreEos.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in IgnoreEos with anyOf schemas: bool, object. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into IgnoreEos with anyOf schemas: bool, object. Details: " + ", ".join(error_messages))
        else:
            return instance
